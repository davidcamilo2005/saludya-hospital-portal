...
|---|---|---|
| 1 | 5. Instalación | Terminal con `npm install` ya completado |
| 2 | 5. Instalación | `frontend/package.json` abierto en VS Code, bloque `devDependencies` |
| 3 | 6. Dónde se practica | Explorador de VS Code con los 6 archivos `.test.js(x)` |
| 4 | 7. Guía paso a paso | Terminal con `npm test`, resultado en verde (41 passed) |
| 5 | 7. Guía paso a paso | Navegador con el reporte HTML de cobertura |

### `02-Testing-Backend-Pytest.docx`

| # | Sección | Qué debe mostrar |
|---|---|---|
| 1 | 5. Instalación | Terminal con `pip install -r requirements-dev.txt` ya completado |
| 2 | 6. Dónde se practica | Explorador de VS Code con los 8 archivos de `backend/tests/` |
| 3 | 7. Guía paso a paso | Terminal con `pytest -v`, lista de pruebas en verde |
| 4 | 7. Guía paso a paso | Navegador con el reporte HTML de cobertura |

### `03-Docker-Compose.docx`

| # | Sección | Qué debe mostrar |
|---|---|---|
| 1 | 5.1 Instalación | Docker Desktop instalado (ícono/pantalla principal) |
| 2 | 6. Guía paso a paso | Terminal ejecutando `docker compose up --build` |
| 3 | 6. Guía paso a paso | `docker compose ps` (o Docker Desktop) con los 3 contenedores healthy |
| 4 | 6. Guía paso a paso | Navegador en `http://localhost:8080` (landing de SaludYa) |
| 5 | 6. Guía paso a paso | Navegador en `http://localhost:8000/docs` (Swagger) |
| 6 | 6. Guía paso a paso | Recorrido funcional (cita agendada, dashboard admin, etc.) |
| 7 | 6. Guía paso a paso | Terminal con el listado de las 6 tablas de la base de datos |
