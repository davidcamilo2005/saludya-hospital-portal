...
| [`docs/evidencias/04-bitacora-resolucion-problemas.md`](../evidencias/04-bitacora-resolucion-problemas.md) | Evaluación académica / referencia técnica | Bitácora real de la sesión de verificación con Docker en GitHub Codespaces: 4 problemas encontrados (caché de BuildKit corrupta, errores de uso de terminal, dependencias no instaladas, ruta raíz de la API sin definir), con síntoma, diagnóstico, comandos exactos y solución de cada uno. |
