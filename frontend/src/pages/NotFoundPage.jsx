...
export default function NotFoundPage() {
  return (
    <div className="flex min-h-[70vh] animate-fade-in-up flex-col items-center justify-center gap-4 px-4 text-center">
      <NotFoundIllustration className="h-48 w-auto" />
